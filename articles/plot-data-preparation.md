...
tern.cv <- RefLidar(tern.cv.dir, raster_type = "CV", allow_interactive = FALSE)
# Using raster type: CV
# Processing raster files with multi-band support...

tail(tern.cv)
#                PLOT_ID  POINT_X   POINT_Y        CV AVG_YEAR
# 24286  ZGZ_2012_CV_100m 148.3180 -37.49671 0.3142311     2012
# 24296  ZGZ_2012_CV_100m 148.3191 -37.49671 0.3190602     2012
# 24304  ZGZ_2012_CV_100m 148.3201 -37.49671 0.3930413     2012
# 243110 ZGZ_2012_CV_100m 148.3211 -37.49671 0.5244141     2012
# 24327  ZGZ_2012_CV_100m 148.3221 -37.49671 0.5503288     2012
# 24335  ZGZ_2012_CV_100m 148.3232 -37.49671 0.4246517     2012

# Obtaining the Above Ground Biomass for each cell in the dataset:
plots_lidar <- RefLidar(tern.agb.dir, raster_type = "AGB", allow_interactive = FALSE)
# Using raster type: AGB
# Processing raster files with multi-band support...

tail(plots_lidar)
#       PLOT_ID  POINT_X   POINT_Y       AGB AVG_YEAR
# 24286     ZGZ 148.3180 -37.49671 151.55905     2012
# 24296     ZGZ 148.3191 -37.49671 145.86589     2012
# 24304     ZGZ 148.3201 -37.49671 110.43783     2012
# 243110    ZGZ 148.3211 -37.49671  56.86149     2012
# 24327     ZGZ 148.3221 -37.49671  52.26966     2012
# 24335     ZGZ 148.3232 -37.49671  94.79680     2012

# Calculating the Standard Deviation (SD = CV * AGB) and adding it to the final plot data:
plots_lidar$sdTree <- tern.cv$CV * plots_lidar$AGB
tail(plots_lidar)
#       PLOT_ID  POINT_X   POINT_Y       AGB AVG_YEAR    sdTree
# 24286      ZGZ 148.3180 -37.49671 151.55905     2012 124.80281
# 24296      ZGZ 148.3191 -37.49671 145.86589     2012 110.25450
# 24304      ZGZ 148.3201 -37.49671 110.43783     2012  88.92837
# 243110     ZGZ 148.3211 -37.49671  56.86149     2012  40.88781
# 24327      ZGZ 148.3221 -37.49671  52.26966     2012  39.72771
# 24335      ZGZ 148.3232 -37.49671  94.79680     2012  69.36698
...
plots_lidar <- TempApplyVar(plots_lidar, map_year = 2015)

# Calculate total uncertainty (measurement, sampling, and growth)
plots_lidar_unc <- calculateTotalUncertainty(plots_lidar, map_year = 2015, map_resolution = 100)
...
#   PLOT_ID AGB_T_HA AVG_YEAR    sdTree  POINT_X   POINT_Y      ZONE
# 1     WRR 232.3062     2014 220.60146 146.6645 -43.12495 Australia
# 2     WRR 171.9812     2014 159.30778 146.6655 -43.12495 Australia
# 3     WRR 444.2952     2014  77.54340 146.6688 -43.12495 Australia
# 4     WRR 353.5665     2014 339.78065 146.6634 -43.12495 Australia
# 5     WRR 355.5949     2014 205.32216 146.6602 -43.12495 Australia
# 6     WRR 320.1187     2014  67.43811 146.6559 -43.12495 Australia
#                FAO.ecozone       GEZ SIZE_HA AGB_T_HA_ORIG sdGrowth RS_HA ratio
# 1 Temperate oceanic forest Temperate       1      231.9362     0.37     1     1
# 2 Temperate oceanic forest Temperate       1      171.6112     0.37     1     1
# 3 Temperate oceanic forest Temperate       1      443.9252     0.37     1     1
# 4 Temperate oceanic forest Temperate       1      353.1965     0.37     1     1
# 5 Temperate oceanic forest Temperate       1      355.2249     0.37     1     1
# 6 Temperate oceanic forest Temperate       1      319.7487     0.37     1     1
#       sdSE    varPlot   sdTotal
# 1 16.17953  48926.918 221.19430
# 2 16.17953  25640.883 160.12771
# 3 16.17953   6274.894  79.21423
# 4 16.17953 115712.806 340.16585
# 5 16.17953  42419.104 205.95899
# 6 16.17953   4809.813  69.35282
...
#  0.79553108  0.18651725  0.01795167 
```
