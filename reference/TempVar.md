...
This function calculates the temporal variance in plot biomass based on
growth rate standard deviations. It computes the standard deviation of
growth for each plot.

## Usage

``` r
TempVar(plt, map_year, gez = "all")
```
...
A data frame with calculated growth standard deviations.
