...
A key principle for climate monitoring is that random errors and time-dependent biases in satellite observations and derived products should be identified. More generally map users prefer AGB maps to be unbiased and to have spatially explicit uncertainty information, including its spatial autocorrelation.
