...
# 1       11 74.91944 14.36806       1     1998 185.812601 12.272846
# 2       12 74.62778 15.16667       1     1998 301.668486 19.112798
# 3       13 74.63667 14.24944       1     1998 160.599641 16.647684
# 4       14 74.66806 14.24528       1     1998 349.610949 20.916878
# 5       15 75.11806 14.28333       1     1998 303.425709 19.913703
# 6       16 75.13583 14.28389       1     1998 427.535715 39.376169
# 7       17 74.87222 14.42500       1     1998 233.888981 12.691625
# 8       18 75.30806 14.44583       1     1998   5.313496  1.659927
# 9       19 75.17222 14.34861       1     1998  81.295106 10.029705
# 10     110 75.28639 14.08750       1     1998  72.996814  6.807416
...
cent <- sf::read_sf(sample_file("SampleCentroid.shp")) # Sub-plot centroids
...
# # A tibble: 5 × 24
#   POINT_GUID    GRID_REF POINT_NUMB VISIT_STAT REASON_FOR PEG_LEFT PEG_NOT_LE PEG_DESCRI PLOT_GUID OBJECTID
#   <chr>         <chr>         <int>      <int>      <int>    <int>      <int> <chr>      <chr>        <int>
# 1 {89B25687-ED… sh72029…          1          3          1        1          0 NW of v. … {ABC3BE5…        1
# 2 {22E69595-D9… sh72018…          1          3          1        1          0 5m N of e… {E76DFF7…        2
# 3 {B4980FC2-4D… sh72092…          1          3          1        1          0 W of larg… {6EFDF9E…        3
# 4 {224FD85B-6B… sh72087…          1          3          1        1          0 in plough… {47011DC…        4
# 5 {197A519B-7A… sh72007…          1          3          1        1          0 N from sm… {EE0EF57…        5
# # ℹ 14 more variables: INACCESSIB <int>, ACCESS_STA <int>, GENERATE_N <int>, HEIGHT <dbl>,
# #   TREE_COUNT <int>, ESTIMATED_ <dbl>, TREE_COU_1 <int>, RECORD_STA <chr>, FIELDS_STA <chr>,
# #   RESURVEY_P <int>, FROZEN <int>, POINT_STUM <int>, ACCESS_COM <chr>, geometry <POINT [m]>
...
plots_trees_nested_agb_sd <- MeasurementErr(plotTree, xyTree, 'Europe')
print(plots_trees_nested_agb_sd)
#                                  PLOT_ID   POINT_X  POINT_Y SIZE_HA AVG_YEAR AGB_T_HA   sdTree
# 1 {197A519B-7AF1-4374-BDD8-81FA03CCC54F} -3.910179 53.03270    0.01     2010 192.3808 27.40171
# 2 {224FD85B-6B64-4075-B51F-BA2D390AB4EF} -3.908944 53.03241    0.01     2010 243.1564 65.49890
# 3 {22E69595-D9BE-4BB1-8660-E2E7457E2068} -3.910026 53.03247    0.01     2010 303.7086 42.19278
# 4 {89B25687-EDA0-4704-B00D-93EDDA162779} -3.909820 53.03270    0.01     2010 291.0694 47.14336
# 5 {B4980FC2-4DA9-4897-93E2-07D03233D2F4} -3.908851 53.03252    0.01     2010 432.0858 91.30732
...
# 21 BON_A01 -67.28247 -9.859331 10.991895     2018
# 54 BON_A01 -67.28337 -9.860239 13.910153     2018
# 55 BON_A01 -67.28247 -9.860239  9.466972     2018
# 56 BON_A01 -67.28156 -9.860239 10.045134     2018
# 87 BON_A01 -67.28428 -9.861147  4.744854     2018
# 88 BON_A01 -67.28337 -9.861147  2.984538     2018
...
# 21 BON_A01 -67.28247 -9.859331 0.2824650     2018  3.104826
# 54 BON_A01 -67.28337 -9.860239 0.1802490     2018  2.507291
# 55 BON_A01 -67.28247 -9.860239 0.3926857     2018  3.717545
# 56 BON_A01 -67.28156 -9.860239 0.3369435     2018  3.384643
# 87 BON_A01 -67.28428 -9.861147 1.4032360     2018  6.658150
# 88 BON_A01 -67.28337 -9.861147 6.1049371     2018 18.220417
