...
Let's see an example where lidar data is used as plot data reference:


```{r lidar_plots, eval=FALSE}


slb.agb.dir <- 'data/SustainableLandscapeBrazil_v04/SLB_AGBmaps'
slb.cv.dir <- 'data/SustainableLandscapeBrazil_v04/SLB_CVmaps'
